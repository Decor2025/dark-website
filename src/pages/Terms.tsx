...
export default function TermsPage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      {/* Header */}
      <section className="bg-gray-50 dark:bg-gray-900 border-b">
      ...
      <section className="max-w-5xl mx-auto px-6 py-10">
        <div className="grid gap-6">
          {/* Scope */}
          <article className="rounded-2xl border bg-white dark:bg-gray-900 p-6 shadow-sm">
            <h2 className="text-xl font-semibold">1) Products & Services</h2>
            <ul className="mt-3 list-disc pl-5 space-y-1 text-sm leading-6 text-gray-700 dark:text-gray-300">
